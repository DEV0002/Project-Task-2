...
namespace Project_Task_2 {
    ...
    partial class Form1 : Form {
        ...
        private static long totMSPF, frames, last, iTime;
        private static Timer graphicsTimer, renderTimer;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e) {
            ...
            if(tasks.TryReceiveAll(out colors)) {
                ...
                System.Runtime.InteropServices.Marshal.Copy(emptyProduct.ToArray(), 0, ptr, emptyProduct.Count);
